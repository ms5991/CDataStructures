...
void test_list_new_int(){
    ...
    printf("[%s]: Test list new int SUCCEEDED\n", __func__);
}
...
void test_list_add_to_front_empty_int(){
    ...
    printf("[%s]: Test list add to front from empty int SUCCEEDED\n", __func__);
}
...
void test_list_get_length()
{
    ...
    printf("[%s]: Test list get length SUCCEEDED\n", __func__);
}
...
void test_list_add_to_front_non_empty_int(){
    ...
    printf("[%s]: Test list add to front from non empty int SUCCEEDED\n", __func__);
...
void test_list_add_to_back_empty_int(){
    ...
    printf("[%s]: Test list add to back from empty int SUCCEEDED\n", __func__);
...
void test_list_add_to_back_non_empty_int(){
    ...
    printf("[%s]: Test list add to back from non empty int SUCCEEDED\n", __func__);
...
void test_list_add_to_pos_zero_empty_int(){
    ...
    printf("[%s]: Test list add to pos from empty to zero int SUCCEEDED\n", __func__);
}
...
void test_list_add_to_pos_length_empty_int(){
    ...
    printf("[%s]: Test list add to pos from empty to length int SUCCEEDED\n", __func__);
}
...
void test_list_add_to_pos_non_empty_int(){
    ...
    printf("[%s]: Test list add to pos from non empty int SUCCEEDED\n", __func__);
}
...
void test_list_delete_from_front_to_empty_int(){
    ...
    printf("[%s]: Test list delete from front to empty int SUCCEEDED\n", __func__);
}
...
void test_list_delete_from_front_to_non_empty_int(){
    ...
    printf("[%s]: Test list delete from front to non empty int SUCCEEDED\n", __func__);
...
void test_list_delete_from_back_to_empty_int(){
    ...
    printf("[%s]: Test list delete from back to empty int SUCCEEDED\n", __func__);
}
...
void test_list_delete_from_back_to_non_empty_int(){
    ...
    printf("[%s]: Test list delete from back to non empty int SUCCEEDED\n", __func__);
}
...
void test_list_add_delete_front_each_position(){
    ...
    printf("[%s]: Test list delete front each position SUCCEEDED\n", __func__);
}
...
void test_list_add_delete_back_each_position(){
    ...
    printf("[%s]: Test list delete back each position SUCCEEDED\n", __func__);
}
...
void test_list_sort_int_even(){
    ...
    printf("[%s]: Test list sort int even SUCCEEDED\n", __func__);
}
...
void test_list_sort_int_odd(){
    ...
    printf("[%s]: Test list sort int odd SUCCEEDED\n", __func__);
...
void test_list_sort_sorted(){
    ...
    printf("[%s]: Test list sort int sorted SUCCEEDED\n", __func__);
...
void test_list_sort_reversed(){
    ...
    printf("[%s]: Test list sort int reversed SUCCEEDED\n", __func__);
...
void test_list_sort_int_empty(){
    ...
    printf("[%s]: Test list sort empty SUCCEEDED\n", __func__);
}
...
void test_list_sort_single_int(){
    ...
    printf("[%s]: Test list sort single SUCCEEDED\n", __func__);
}
...
void test_list_new_str(){
    ...
    printf("[%s]: Test list new str SUCCEEDED\n", __func__);
}
...
void test_list_add_to_front_empty_str(){
    ...
    printf("[%s]: Test list add to front from empty str SUCCEEDED\n", __func__);
}
